...
class Token {
    ...
    getTokenFromServer(data,params,callback) {
        ...
        wx.login({
            success: function (res) {
                ...
                wx.request({
                    url: 'https://sywskxcx.futuretoday.top/api/public/index.php/api/v1/Base/ProgrameToken/get',
                    method:'POST',
                    data:postData,
                    success:function(res){
                        console.log(res)
    ...
    getToken(callback,params){
        ...
        if(wx.getStorageSync('login').login_name&&wx.getStorageSync('login').password){
            ...
            wx.request({
                url: 'https://sywskxcx.futuretoday.top/api/public/index.php/api/v1/Func/Common/loginByUp',
                method:'POST',
                data:postData,
                success:function(res){
                    console.log(res)
